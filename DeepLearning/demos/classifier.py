...
def train(args):
    ...
    print("SVM training time = {}".format(time.time() - start))
...
def infer(args, multiple=False):
    ...
    file = io.FileIO("prediction_results.txt", "a")

    start = time.time()

    for img in args.imgs:
        #print("\n=== {} ===".format(img))
        predicting = ("{} ".format(img))
        ...
        for r in reps:
            ...
            prediction_time = ("{} " .format(time.time()-start))
            if args.verbose:
                print("Prediction took {} seconds.".format(time.time() - start))
            if multiple:
                ...
                if person in predicting:
                    print ("{} {} {} {:.2f} 1".format(predicting, prediction_time, person, confidence))
                    file.write("{} {} {} {:.2f} 1\n".format(predicting, prediction_time, person, confidence))
                else :
                    print ("{} {} {} {:.2f} 0".format(predicting, prediction_time, person, confidence))
                    file.write("{} {} {} {:.2f} 0\n".format(predicting, prediction_time, person, confidence))
